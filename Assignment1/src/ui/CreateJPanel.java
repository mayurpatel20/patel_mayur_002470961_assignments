...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    String drivenumber = txtDrivenumber.getText();
    String drivestate = txtDrivestate.getText();
    ...
    personprofile.setDateofbirth(dob);
    personprofile.setNationality(nationality);
    personprofile.setGender(gender);
    personprofile.setEmail(email);
    personprofile.setEducationlevel(education);
    personprofile.setPhone(phone);
    personprofile.setEmergencycontactphone(emergency);
    personprofile.setPassportnumber(passport);
    personprofile.setDriverslicensenumber(drivenumber);
    personprofile.setDriverslicensestate(drivestate);
    personprofile.setSocialsecuritynumber(socialno);
    personprofile.setAddressline1(address1);
    personprofile.setAddressline2(address2);
    personprofile.setCity(city);
    personprofile.setState(state);
    personprofile.setZip(zip);
    personprofile.setTelephonenumber(teleno);
    personprofile.setFaxnumber(faxno);
    
    JOptionPane.showMessageDialog( this, "Personprofile Saved!", "success",JOptionPane.PLAIN_MESSAGE);
    ...
    txtPassport.setText("");
    txtDrivenumber.setText("");
    txtDrivestate.setText("");
    txtSocialno.setText("");
    txtAddress1.setText("");
    txtAddress2.setText("");
    txtCity.setText("");
